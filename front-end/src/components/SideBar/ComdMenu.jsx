  ...
  return (
    ...
    >
      <div onClick={(e) => e.stopPropagation()}
        ...
        border overflow-hidden max-h-full max-w-lg mx-auto mt-12
        '
        >
        <Command.Input 
          value={value}
          onValueChange={setValue}
          placeholder="what do your need?"
          className="relative border-b border-stone-300 p-3 text-lg
        ...
        <Command.List className='p-3'>
            ...
            <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm
                text-stone-50 hover:bg-stone-700 bg-stone-950 rounded items-center gap-2
              '>
                <FiLogOut/>
                Sign Out
              </Command.Item>
